...
class ListingController extends Controller implements HasMiddleware
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'tel' => 'Поле телефона обязательно для заполнения.',
        ...
        return redirect()->route('dashboard')->with('status', 'Запись успешно создана.');
    }
    ...
    public function update(Request $request, Listing $listing)
    {
        ...
        return redirect()->route('dashboard')->with('status', 'Объявление успешно обновлено.');
    }
    ...
    public function destroy(Listing $listing)
    {
        ...
        return redirect()->route('dashboard')->with('status', 'Объявление успешно удалено.');
    }
}
